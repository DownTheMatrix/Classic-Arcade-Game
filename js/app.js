...
/* DOM Events */
document.addEventListener("DOMContentLoaded", showHeroSelectionModal);
const modal = document.querySelector(".md-modal");
const winningModal = document.querySelector("#winning-modal");
const losingModal = document.querySelector("#losing-modal");
...
function showLosingModal() {
  losingModal.classList.add("md-show");
}
...
class Player extends Enemy {
  ...
  // Trigger the losing modal when ran out of lives
  gameOver() {
    if (this.lives === 0) {
      showLosingModal();
    }
